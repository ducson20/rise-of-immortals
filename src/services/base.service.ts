...
export class BaseService<T extends TBaseRequest, R extends TBaseResponse> {
  static _instance = new BaseService();
  ...
  async getSelectOptions(categoryIdList?: string[]) {
    ...
    return Object.keys(codeTable).reduce((response: any, categoryId: string) => {
...
export default BaseService._instance;
